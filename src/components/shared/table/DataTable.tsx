    ...
    onSortingChange: sorting
      ? (updater) => {
          ...
          const nextSortingState =
            typeof updater === "function" ? updater(currentSortingState) : updater;
                    ...
                    {header.isPlaceholder ? null : header.column.getCanSort() ? (
                      ...
                      >
                        ...
                        {header.column.getIsSorted() === "asc" ? (
                          ...
                          <ArrowDown className="ml-2 h-4 w-4" /> // removed rotate-180
                        ) : (
                          <ArrowUpDown className="ml-2 h-4 w-4 text-muted-foreground/50" /> // neutral state
                        )}
                      </Button>
                    ) : (
                      flexRender(header.column.columnDef.header, header.getContext())
